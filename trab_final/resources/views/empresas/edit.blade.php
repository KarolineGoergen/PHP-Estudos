@extends('templates.main', ['titulo' => "Alterar Empresa"])
@section('titulo') Empresas @endsection
@section('conteudo')

<form action="{{ route('empresas.update', $dados['id']) }}" method="POST">
    @csrf
    @method('PUT')
    <div class="row">
            <div class="col" >
        ...
        <div class="row">
            <div class="col">
                <a href="{{route('empresas.index')}}" class="btn btn-secondary btn-block align-content-center">
