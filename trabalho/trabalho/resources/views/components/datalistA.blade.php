            ...
            @foreach ($data as $item)
                <tr>
                    ...
                    <td>
                        ...
                        <a href= "{{ route('alunos.show', $item['id']) }}" class="btn btn-outline-primary">
                        ...
                        <button nohref style="cursor:pointer" onclick="showRemoveModal('{{ $item['id'] }}', '{{ $item['nome'] }}')" class="btn btn-outline-danger">
